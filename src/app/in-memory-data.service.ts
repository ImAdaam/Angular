...
export class InMemoryDataService implements InMemoryDbService {
  createDb() {
    ...
    const receptjeim: Recept[] = [
      ...
      { id: 6, kodneve: 'Palacsinta', cim: 'Palacsinta recept', leiras: 'Finom palacsinta recept', hozzavalok: hozzavalok.filter(h => h.receptId === 1), allergenek: [allergenek[1]] },
      { id: 7, kodneve: 'Rántotta', cim: 'Rántotta recept', leiras: 'Egyszerű rántotta recept', hozzavalok: hozzavalok.filter(h => h.receptId === 2), allergenek: [allergenek[2]] },
      { id: 8, kodneve: 'Sóskafőzelék', cim: 'Sóskafőzelék recept', leiras: 'Klasszikus sóskafőzelék recept', hozzavalok: hozzavalok.filter(h => h.receptId === 3), allergenek: [allergenek[1], allergenek[0]] },
      { id: 9, kodneve: 'Sült krumpli', cim: 'Sült krumpli recept', leiras: 'Ropogós sült krumpli recept', hozzavalok: hozzavalok.filter(h => h.receptId === 4), allergenek: [] },
      { id: 10, kodneve: 'Tejbegríz', cim: 'Tejbegríz recept', leiras: 'Gyermekkorunk kedvence, tejbegríz', hozzavalok: hozzavalok.filter(h => h.receptId === 1).concat({ id: 7, anyagId: 3, anyag: anyagok[3], mennyiseg: 300, egyseg: 'ml', receptId: 5, hozzavaloCsoportok: [] }), allergenek: [allergenek[1]] },
      { id: 11, kodneve: 'Palacsinta', cim: 'Palacsinta recept', leiras: 'Finom palacsinta recept', hozzavalok: hozzavalok.filter(h => h.receptId === 1), allergenek: [allergenek[1]] },
      { id: 12, kodneve: 'Rántotta', cim: 'Rántotta recept', leiras: 'Egyszerű rántotta recept', hozzavalok: hozzavalok.filter(h => h.receptId === 2), allergenek: [allergenek[2]] },
      { id: 13, kodneve: 'Sóskafőzelék', cim: 'Sóskafőzelék recept', leiras: 'Klasszikus sóskafőzelék recept', hozzavalok: hozzavalok.filter(h => h.receptId === 3), allergenek: [allergenek[1], allergenek[0]] },
      { id: 14, kodneve: 'Sült krumpli', cim: 'Sült krumpli recept', leiras: 'Ropogós sült krumpli recept', hozzavalok: hozzavalok.filter(h => h.receptId === 4), allergenek: [] },
      { id: 15, kodneve: 'Tejbegríz', cim: 'Tejbegríz recept', leiras: 'Gyermekkorunk kedvence, tejbegríz', hozzavalok: hozzavalok.filter(h => h.receptId === 1).concat({ id: 7, anyagId: 3, anyag: anyagok[3], mennyiseg: 300, egyseg: 'ml', receptId: 5, hozzavaloCsoportok: [] }), allergenek: [allergenek[1]] },
      { id: 16, kodneve: 'Palacsinta', cim: 'Palacsinta recept', leiras: 'Finom palacsinta recept', hozzavalok: hozzavalok.filter(h => h.receptId === 1), allergenek: [allergenek[1]] },
      { id: 17, kodneve: 'Rántotta', cim: 'Rántotta recept', leiras: 'Egyszerű rántotta recept', hozzavalok: hozzavalok.filter(h => h.receptId === 2), allergenek: [allergenek[2]] },
      { id: 18, kodneve: 'Sóskafőzelék', cim: 'Sóskafőzelék recept', leiras: 'Klasszikus sóskafőzelék recept', hozzavalok: hozzavalok.filter(h => h.receptId === 3), allergenek: [allergenek[1], allergenek[0]] },
      { id: 19, kodneve: 'Sült krumpli', cim: 'Sült krumpli recept', leiras: 'Ropogós sült krumpli recept', hozzavalok: hozzavalok.filter(h => h.receptId === 4), allergenek: [] },
      { id: 20, kodneve: 'Tejbegríz', cim: 'Tejbegríz recept', leiras: 'Gyermekkorunk kedvence, tejbegríz', hozzavalok: hozzavalok.filter(h => h.receptId === 1).concat({ id: 7, anyagId: 3, anyag: anyagok[3], mennyiseg: 300, egyseg: 'ml', receptId: 5, hozzavaloCsoportok: [] }), allergenek: [allergenek[1]] },
    ];
